 ...
 * <body data-page="wizard|review|dashboard|analytics|comment-automations">
 */
(function () {
  var ICONS = {
  ...
  function mount() {
    ...
    var links = [
      ...
      { href: "/connect.html",                label: "Social accounts",         key: "connect"               },
    ...
    var pageTitles = {
      ...
      'comment-automations': 'Comment Automations',
    };
