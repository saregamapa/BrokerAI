...
(function () {
  ...
  function mount() {
    ...
    var pageTitles = { dashboard: 'Dashboard', wizard: 'New Campaign', templates: 'Templates', review: 'Review Posts', analytics: 'Performance', connect: 'Connect Social Media Accounts', 'comment-automations': 'Comment Automations' };
